...
uint16_t _spi_read_write(uint8_t data);
/*******************************************************************************
...
//	SPI1_MISO_INPUT();
//	
//	NRF_SPI1->PSELSCK = SD_CLK;
//	NRF_SPI1->PSELMISO = SD_MISO;
//	NRF_SPI1->PSELMOSI = SD_MOSI;
//	NRF_SPI1->FREQUENCY = 0x10000000;  
//	NRF_SPI1->CONFIG = 0x00;

  _card_disable(); 

  //MSD_SPIHighSpeed(0);		

  //NRF_SPI1->ENABLE = 0x1; //SPI1_ Enable
}
